...
POM_SNAPSHOT_VERSION=${env.POM_VERSION}
...
echo "DEBUG - Major version: ${env.POM_MAJOR_VERSION}"
echo "DEBUG - Minor version: ${env.POM_MINOR_VERSION}"
echo "DEBUG - Patch version: ${env.POM_PATCH_VERSION}"
